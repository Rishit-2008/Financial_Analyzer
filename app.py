...
def search_stocks(query: str) -> List[Dict]:
    ...
    try:
        ...
        {{
            "matches": [
                {{"symbol": "AAPL", "reason": "Major technology company with significant market presence"}},
                {{"symbol": "GOOGL", "reason": "Leading tech company in the specified area"}}
            ]
        }}
        Only include actual NYSE/NASDAQ listed companies.
        Limit to 5 most relevant matches.
        """
...
def process_article(article_text: str, article_title: str) -> Optional[Dict]:
    ...
    try:
        ...
        Analyze this article and provide a structured analysis in the following JSON format:
        {{
        ...
        Focus on extracting factual information and clear sentiment signals.
        """
